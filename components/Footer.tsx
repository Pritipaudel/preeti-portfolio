...
export function Footer() {
  ...
  return (
    <footer
      className="relative border-t border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900/50"
      role="contentinfo"
    >
      <div className="absolute inset-0 h-px bg-gradient-to-r from-transparent via-zinc-200 to-transparent dark:via-zinc-700" style={{ top: 0 }} aria-hidden />
      <div className="container-wide section-padding">
        ...
        <div className="mt-8 flex items-center justify-between border-t border-zinc-200 pt-8 dark:border-zinc-700">
